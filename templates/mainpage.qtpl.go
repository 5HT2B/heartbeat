...
<script>
    ...
    function updateInfo(data) {
        setInfo("LastSeen", data.last_seen, "Last response time")
        setInfo("TimeDifference", data.time_difference, "Time since last response")
        setInfo("MissingBeat", data.missing_beat, "Longest recorded absence")
        setInfo("TotalBeats", data.total_beats, "Total beats received")
    }
